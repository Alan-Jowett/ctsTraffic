...
void ctsMediaStreamSender::QueueTask(const ctsTask& task) noexcept
{
...
void ctsMediaStreamSender::Start() noexcept
{
...
VOID CALLBACK ctsMediaStreamSender::MediaStreamTimerCallback(PTP_CALLBACK_INSTANCE, PVOID context, PTP_TIMER) noexcept
{
    ...
    wsIOResult ctsMediaStreamSender::PerformIo() noexcept
    {
